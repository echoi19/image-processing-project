...
## CNN Project
* [Building Model](https://blog.keras.io/building-powerful-image-classification-models-using-very-little-data.html)
  * [Training a small convnet from scratch: 80% accuracy in 40 lines of code](https://gist.github.com/fchollet/0830affa1f7f19fd47b06d4cf89ed44d)
  * [Using the bottleneck features of a pre-trained network: 90% accuracy in a minute](https://gist.github.com/fchollet/f35fbc80e066a49d65f1688a7e99f069)
  * [Fine-tuning the top layers of a a pre-trained network](https://gist.github.com/fchollet/7eb39b44eb9e16e59632d25fb3119975)
